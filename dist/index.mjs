...
var getModelYear = (vin) => {
  ...
  const possibleModelYears = years[candidateModelYear];
  const validationCharacter = vin.substring(6, 7);
  const modelYear = /^\d+$/.test(validationCharacter) ? ((_a = possibleModelYears == null ? void 0 : possibleModelYears.find((year) => year < 2010)) == null ? void 0 : _a.toString()) || "-" : ((_b = possibleModelYears == null ? void 0 : possibleModelYears.find((year) => year >= 2010)) == null ? void 0 : _b.toString()) || "-";
